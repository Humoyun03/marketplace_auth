    ...
    return _then(_value.copyWith(
      ...
      phone: null == phone
          ...
          : phone // ignore: cast_nullable_to_non_nullable
              as String,
      otpSessionId: null == otpSessionId
          ? _value.otpSessionId
...
class _$SignUpRequestImpl implements _SignUpRequest {
  ...
  @override
  String toString() {
    return 'SignUpRequest(code: $code, name: $name, isAgreed: $isAgreed, phone: $phone, otpSessionId: $otpSessionId)';
  }
